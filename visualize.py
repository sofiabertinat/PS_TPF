...
STREAM_FILE=("COM6","serial")
#STREAM_FILE=("log.bin","file")

header = { "pre": b"*header*", "id": 0, "N": 128, "fs": 8000,"M":0, "pos":b"end*" }
fig    = plt.figure ( 1 )
...
adcLn, = plt.plot        ( [],[],'r-o',linewidth = 3, alpha = 0.3 ,label = "adc")
adcLg  = adcAxe.legend()
adcAxe.grid     ( True      )
...
hLn, = plt.plot ( [] ,[] ,'r-o' ,linewidth = 3  ,alpha = 0.3 ,label = "h")
hLg  = hAxe.legend()
hAxe.grid     ( True      )
...
ciaaConvLn,     = plt.plot ( [] ,[] ,'r-o' ,linewidth = 3  ,alpha = 0.3 ,label = "ciaaConv" )
...
XLn, = plt.plot        ( [],[],'b-o',linewidth = 3, alpha = 0.3 ,label = "X")
XLg  = XAxe.legend()
XAxe.grid     ( True      )
...
HLn, = plt.plot ( [] ,[] ,'b-o' ,linewidth = 3  ,alpha = 0.3 ,label = "H")
HLg  = HAxe.legend()
HAxe.grid     ( True  )
HAxe.set_ylim ( -1 ,1 )
...
YLn, = plt.plot ( [] ,[] ,'b-o' ,linewidth = 3  ,alpha = 0.3 ,label = "Y" )
YLg  = YAxe.legend()
